<footer class="footer">
    ...
    <div style="text-align: center; padding-top: 30px; margin-top: 30px; border-top: 1px solid #333; font-size: 13px; color: #888;">
        <p>&copy; <?= date('Y') ?> Mentas.id - Ruang Arsip, Wacana, dan Ekosistem Seni-Budaya</p>
    </div>
</footer>
